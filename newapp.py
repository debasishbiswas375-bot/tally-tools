...
# Sidebar
with st.sidebar:
    # Try to load sidebar logo if you want, otherwise just title
    ...
    3. **Upload Excel:** Upload your bank statement.
    4. **Generate:** Download the XML.
    """)
    st.markdown("---")
...
with col_logo:
    try:
        # Looks for logo.png in your repository
...
with col_title:
    ...
    st.markdown('<p class="sub-header">Automate your Tally accounting in seconds.</p>', unsafe_allow_html=True)
