...
st.markdown("""
    <style>
        ...
        /* Card-like containers for steps */
        .step-container {
...
with st.sidebar:
    st.image("https://cdn-icons-png.flaticon.com/512/2920/2920349.png", width=80) # Placeholder Logo
    st.title("Tally Tools")
    st.markdown("---")
    st.markdown("### 📝 Instructions")
    st.markdown("""
    1. **Upload Master:** Load your 'List of Accounts.html' from Tally.
    2. **Settings:** Choose your Bank Ledger and Suspense Ledger.
    3. **Upload Excel:** Upload your bank statement (SBI, HDFC, ICICI, etc.).
    4. **Generate:** Download the XML and import into Tally.
    """)
    st.markdown("---")
...
with col_logo:
    # You can replace this URL with your own logo file: st.image("logo.png")
    st.markdown("## 📊") 
with col_title:
    st.markdown('<p class="main-header">Bank to Tally XML</p>', unsafe_allow_html=True)
    st.markdown('<p class="sub-header">Automate your accounting workflow in seconds.</p>', unsafe_allow_html=True)
...
st.markdown("""
    <div class="footer">
        <p>Powered by <b>Your Brand Name</b> | Developed with Streamlit 🚀</p>
    </div>
""", unsafe_allow_html=True)
